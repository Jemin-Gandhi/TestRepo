...
public final class Program1Parse1 extends Program1 {
    ...
    private static String parseInstruction(Queue<String> tokens,
        ...
        tokens.dequeue(); // dequeue the "Instruction" string.
        String str = tokens.dequeue(); // get the starting name of instruction.
        /*
    ...
    public void parse(Queue<String> tokens) {
        ...
        Reporter.assertElseFatalError(program.equals("PROGRAM"),
                "The prefix should be PROGRAM.");
        String str = tokens.dequeue(); // get the starting name of program.
        /*
         * check if the start name is identifier.
         */
        Reporter.assertElseFatalError(Tokenizer.isIdentifier(str),
        ...
        while (next.equals("INSTRUCTION")) {
            ...
            String instructionName = parseInstruction(tokens, b);
            boolean recursive = !c.hasKey(instructionName);
            Reporter.assertElseFatalError(recursive,
                    "The instructionName cannot be " + "recursively called.");
            c.add(instructionName, b);
            next = tokens.front();
        }
