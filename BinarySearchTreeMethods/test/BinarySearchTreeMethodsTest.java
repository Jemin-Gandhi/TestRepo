...
public final class BinarySearchTreeMethodsTest {
    ...
    @Test
    public void IsInTreeMoreTrueTest() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("b", "a", "c");
    ...
    @Test
    public void IsInTreeMoreFalseTest() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("b", "a", "c");
    ...
    @Test
    public void removeSmallestOneTest() {
        /*
         * Set up variables
         */
    ...
    @Test
    public void removeSmallestNoLeftTreeTest() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("b", "c", "d");
        BinaryTree<String> t2 = createBSTFromArgs("c", "d");
        /*
         * Call method under test
         */
        String smallest = BinarySearchTreeMethods.removeSmallest(t1);
    ...
    @Test
    public void removeSmallestMoreTest() {
        /*
         * Set up variables
         */
        BinaryTree<String> t1 = createBSTFromArgs("b", "c", "d", "a");
        BinaryTree<String> t2 = createBSTFromArgs("b", "c", "d");
        /*
         * Call method under test
         */
        String smallest = BinarySearchTreeMethods.removeSmallest(t1);
